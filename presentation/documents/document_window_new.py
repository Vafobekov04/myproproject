...
class DocumentWindow(QWidget):
    ...
    def add(self):
        ...
        if not self.selected_file_path:
            QMessageBox.warning(self, "Ошибка", "Выберите файл документа!")
            return
        ...
        try:
            ...
            self.load_data()
            QMessageBox.information(self, "Успешно", "Документ добавлен!")

        except Exception as e:
            QMessageBox.critical(self, "Ошибка", f"Ошибка добавления документа: {str(e)}")
